...
//    }
    ...
    public void shouldInsertVisit() {
        ...
        visit.setVet(clinicService.findVetById(3));
    ...
    @Test
    @Transactional
    public void shouldFindPetsVisitByVet() {
        Collection<Pet> pets = clinicService.findPetVisitedByVet(3);
        assertThat(pets.size()).isEqualTo(2);
        Pet pet = EntityUtils.getById(pets, Pet.class, 7);
        assertThat(pet.getName()).isEqualTo("Samantha");
        pet = EntityUtils.getById(pets, Pet.class, 8);
        assertThat(pet.getName()).isEqualTo("Max");
    }

    @Test
    @Transactional
    public void shouldFindPetsOwnedByOwnerId() {
        Collection<Pet> pets = clinicService.findPetByOwnerId(3);
        assertThat(pets.size()).isEqualTo(2);
        Pet pet = EntityUtils.getById(pets, Pet.class, 3);
        assertThat(pet.getName()).isEqualTo("Rosy");
        pet = EntityUtils.getById(pets, Pet.class, 4);
        assertThat(pet.getName()).isEqualTo("Jewel");
    }
